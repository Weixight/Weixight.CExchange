...
using Weixight.CExchange.Service.IRepositotory;
...
namespace Weixight.CExchange.Service.Interface
{
         ...
         where TContext : ApplicationDbContext, new()
    {
        ...
        private ApplicationDbContext _objTran;
        ...
        public RepositoryBase<T>   repositoryBase<T>() where T : class
        {
            ...
            {
                var repositoryType = typeof(RepositoryBase<T>);
                var repositoryInstance = Activator.CreateInstance(repositoryType.MakeGenericType(typeof(T)), _context);
                _repositories.Add(type, repositoryInstance);
            }
            return (RepositoryBase<T>)_repositories[type];
        }
    }
}
